...
import com.example.quizme.Result
import kotlinx.android.synthetic.main.activity_ques.*
...
class QuesActivity : AppCompatActivity() {
    ...
    private var questionList:ArrayList<QuessData> ? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        submit.setOnClickListener {
            if(selecedOption!=0)
            {
                ...
                {
                    setColor(selecedOption,R.drawable.wrongquestion_option)
                }else{
                    score++;
                }
                setColor(question.correct_answer,R.drawable.correctquestion_option)
    ...
    fun selectedOptionStyle(view:TextView,opt:Int){
        ...
        setOptionStyle()
        selecedOption=opt
        view.background=ContextCompat.getDrawable(this,R.drawable.selectedquestion_option)
